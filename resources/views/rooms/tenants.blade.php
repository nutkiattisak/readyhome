                ...
                <div class="card-body">
                    ...
                    <form class="" method="POST">
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <div class="position-relative form-group">
                                    <label for="lastname" class="">ชื่อเล่น</label>
                                    <input name="lastname" id="lastname" placeholder="ชื่อเล่น" type="text" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group">
                                    <label for="phone" class="">เพศ</label>
                                    <select name="phone" id="phone" placeholder="เพศ" class="form-control">
                        ...
                        <button class="mt-2 btn btn-primary">เพิ่มผู้เช่า</button>
                    </form>
                </div>
            </div>
        </div>
